...
export const PLATFORM_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    id: 'goals',
    title: 'Goals',
    body: 'Browse and import goals data. HR and admins can upload CSV files from here.',
    target: '[data-tour="nav-goals"]',
    placement: 'right',
    requiresAnyPage: ['goals'],
  },
  {
    id: 'analytics',
    title: 'Analytics',
    body: 'Monitoring tracks goal check-ins. Explore builds custom charts. Reviewers and Calibration support review operations.',
