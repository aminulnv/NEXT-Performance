...
export interface TopBarProps {
  ...
  isMobile?: boolean
  /** Child routes for the active sidebar section (horizontal tabs in the top bar). */
  subNavItems?: NavItemChild[]
}
      ...
      {open && (
        <div style={panelStyle} role="menu" aria-label="Profile menu">
          ...
          <button
            ...
            className="topbar-dropdown-item"
            style={itemStyle}
            onClick={() => handleNav(routes.account.profile)}
            role="menuitem"
          >
          ...
          <button
            ...
            className="topbar-dropdown-item"
            style={itemStyle}
            onClick={() => handleNav(routes.admin.settings)}
            role="menuitem"
          >
...
export function TopBar({
    ...
    return (
      ...
      >
        ...
        {hasSubNav && subNavItems ? (
          ...
          >
            <TopBarSubNav items={subNavItems} compact />
          </div>
        ) : null}
      </header>
    )
  ...
  const centerContent = hasSubNav ? (
    <TopBarSubNav items={subNavItems!} />
  ) : (
    centerSlot ??
  ...
  return (
    ...
    >
      <div
        data-tour="topbar-title"
        style={{
          flex: hasSubNav ? '0 1 auto' : 1,
          minWidth: 0,
          maxWidth: hasSubNav ? '12rem' : undefined,
          overflow: 'hidden',
          display: 'flex',
          alignItems: 'center',
          gap: '0.5rem',
      ...
      {centerContent ? (
        <div style={{ flex: 1, minWidth: 0, display: 'flex', justifyContent: 'center', padding: '0 0.5rem' }}>
          {centerContent}
        </div>
      ) : (
        <div style={{ flex: 1 }} />
