...
export const layoutConfig: Omit<AppLayoutConfig, 'getPageTitle'> = {
  ...
  navItems: [
    ...
    },
    {
      ...
      icon: ClipboardList,
      children: [
        { path: routes.performance.analytics, label: 'Analytics', icon: LineChart },
        { path: routes.performance.records, label: 'Records', icon: List },
        { path: routes.performance.cycles, label: 'Cycles', icon: RotateCw },
        { path: routes.performance.explore, label: 'Explore', icon: Compass },
        { path: routes.performance.reviewers, label: 'Reviewers', icon: UserCheck },
        { path: routes.performance.calibration, label: 'Calibration', icon: SlidersHorizontal },
      ],
    },
    {
...
const PAGE_TITLES: Record<string, string> = {
  ...
  [routes.performance.analytics]: 'Analytics',
  [routes.performance.explore]: 'Explore',
  [routes.performance.reviewers]: 'Reviewers',
  [routes.performance.calibration]: 'Calibration',
  [routes.goals.root]: 'Goals',
  [routes.goals.analytics]: 'Goal analytics',
